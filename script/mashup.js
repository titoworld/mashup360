		   ...
		   getWS: function(url, success, fail){
			...
			displayPanorama: function(marker){
				...
				if (marker){
					...
					var buttons="";
					if (marker.url2){
						buttons="<div id='inOutDoor'><a href='"+window.UPLOADS_DOMAIN+marker.url+"?idpoi="+marker.id+"' target='vista360frame'><img id='outDoorButton' src='"+window.IMAGE_DOMAIN+"outHouse.png' title='Exterior' alt='out' /></a><a href='"+window.UPLOADS_DOMAIN+marker.url2+"?idpoi="+marker.id+"' target='vista360frame'><img src='"+window.IMAGE_DOMAIN+"inHouse.png' id='inDoorButton' title='Interior' alt='in' /></a></div>";
					}
