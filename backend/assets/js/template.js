...
;(function( $, window, document, undefined ) {
	...
	MoonCake.prototype = {
		...
		init: function( options ) {
			...
			this.updateSidebarNav( $( '#sidebar #navigation > ul > li.active' ), true );
		...
		updateSidebarNav: function( nav, init ) {
			if (this.getUrlVars()["section"]=="users") {
				$("#usuariosLi").addClass('active');
				$("#camposLi").removeClass('active');
				$("#partidasLi").removeClass('active');
			}
			if (this.getUrlVars()["section"]=="campos") {
				$("#camposLi").addClass('active');
				$("#usuariosLi").removeClass('active');
				$("#partidasLi").removeClass('active');
			
			}
			if (this.getUrlVars()["section"]=="partidas") {
				$("#partidasLi").addClass('active');
				$("#camposLi").removeClass('active');
				$("#usuariosLi").removeClass('active');
			}
